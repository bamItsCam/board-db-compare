...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '[::1]', '54.218.41.173']
...
WSGI_APPLICATION = 'sbc_compare.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "sbc_compare/static"),
]
